...
export const SettingsModal = ({ settings, onSave, onClose }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    tavilyApiKey:
      import.meta.env.VITE_TAVILY_API_KEY || settings.tavilyApiKey || "",
    endpoint:
    ...
    pollinationsModel: settings.pollinationsModel || "openai-large",
  });
      ...
      <div className="modal glassmorphic-card">
        ...
        <div className="modal-body">
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              <div className="toggle-container">
                ...
                <div className="toggle-switch-container">
                  <span
                    className={`toggle-label ${!formData.usePollinationsAi ? "active" : ""}`}
                  >
                    Azure
                  </span>
                ...
                <p className="form-help">
                  Switch between Azure API and Pollinations.ai for text
                  generation.
                </p>
              </div>
            </div>
              ...
              <>
                <div className="form-group">
                  ...
                  <p className="form-help">
                    ...
                    servers. You can also set this in the .env file.
                  </p>
                </div>
                ...
                <div className="form-group">
                  ...
                  />
                  <p className="form-help">
                    The base URL for API requests. You can also set this in the
                    .env file.
                  </p>
                </div>
                ...
                <div className="form-group">
                  ...
                  >
                    ...
                    <option value="Phi-4-multimodal-instruct">
                      Phi-4-multimodal-instruct
                    </option>
                    <option value="Llama-3.3-70B-Instruct">
            ...
            {formData.usePollinationsAi && (
              <div className="form-group">
                <label className="form-label" htmlFor="pollinationsModel">
                ...
                <p className="form-help">
                  Select the Pollinations.ai model to use for generating
                  responses.
                </p>
              </div>
            )}
            ...
            <div className="form-group">
              <label className="form-label" htmlFor="tavilyApiKey">
                Tavily API Key*
              </label>
              <input
                className="form-input neumorphic"
              ...
              />
              <p className="form-help">
                Required for web search functionality. Get your key from Tavily.
                You can also set this in the .env file.
              </p>
            </div>
            ...
            <div className="form-group">
              ...
              <p className="form-help">
                Controls the randomness of the AI's responses. Lower values make
            ...
            <div className="form-group">
              ...
              />
              <p className="form-help">
                Maximum length of the generated response. Higher values allow
                longer responses.
              </p>
            </div>
          </form>
        ...
        <div className="modal-footer">
          <button
            type="button"
            className="btn btn-secondary neumorphic"
            onClick={onClose}
          >
            Cancel
          </button>
          <button
            type="button"
            className="btn btn-primary neumorphic"
